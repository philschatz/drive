...
// Under preact, moving the pointer from a menu into a submenu focuses a submenu
// item, which Radix's DismissableLayer mis-reads as focus moving *outside* the
// parent menu (the nested submenu isn't recognized as a branch the way it is in
// React), dismissing the whole menu. Preventing the focus-outside default stops
// that; menus still close on outside-click, Escape, and item selection.
const preventFocusOutside = (e: Event) => e.preventDefault();
